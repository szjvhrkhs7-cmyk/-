...
const AI_TRENDS=[
  {
    ...
    "title": "Зависимость от нескольких поставщиков ИИ становится банковским риском"
  },
  {
    "id": "ai-rbi-governance",
    "title": "Регуляторы требуют реестр моделей и ответственность на уровне совета директоров"
  },
  {
    "id": "ai-chinese-models-russia",
    "title": "Российский бизнес резко нарастил использование китайских моделей"
  },
  {
    "id": "ai-gigaagent",
    "title": "Автономные агенты переходят к длительной работе без постоянного контроля"
  },
  {
    "id": "ai-data-readiness",
    "title": "Качество и происхождение данных ограничивают масштабирование ИИ"
  }
];
